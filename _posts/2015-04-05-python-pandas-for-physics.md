...
You might also want to consider the <a title="The Stoner Python Package" href="https://github.com/stonerlab/Stoner-PythonCode">Stoner python package</a> - a 'home-grown' analysis package made at the university of Leeds. It's not as polished or well supported as pandas, but it was built from the ground up as a physics analysis package.
