...
<h2>Windows</h2>
One way to load oommf is to double click on the oommf icon. If you installed tcl correctly (see <a title="OOMMF Tutorial Part 1: Download OOMMF and Tcl/tk" href="{{site.url}}/2014/05/18/oommf-tutorial-part-1-download-oommf-and-tcltk/">part 1</a>), then it should load oommf with no problems.
...
See also: <a title="Adding directories to the PATH" href="{{site.url}}/2014/05/19/adding-directories-to-the-path/">Adding directories to the path</a>
<h2>Linux</h2>
...
| ![Clicking through the OOMMF windows to load Oxsii]({{site.url}}/assets/2014/05/Slide3.png) |
|:--:|
