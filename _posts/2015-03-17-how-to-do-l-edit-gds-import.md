...
<h3><a title="Layout Design Software" href="{{site.url}}/2015/02/21/layout-design-software/">Check out my picks for different layout design software</a></h3>
...
| ![L-edit GDS import - new file]({{site.url}}/assets/2015/03/NewFile.png) |
|:--:|
...
| ![L-edit GDS import  - Import mask data]({{site.url}}/assets/2015/03/ImportMaskData.png) |
|:--:|
| *L-edit GDS import  - Import mask data* |

You will have the chance to select the gds import options:

| ![L-edit GDS import - GDS settings]({{site.url}}/assets/2015/03/ImportGDS_pt2.png) |
|:--:|
| *L-edit GDS import - GDS settings* |

If your import works correctly, you should end up with something like this:

| ![L-edit GDS import - end result]({{site.url}}/assets/2015/03/ImportGDS_pt3.png) |
|:--:|
