...
Having the mean and standard deviation of your Monte Carlo Integration estimates means you can also think about calculating <a href="{{site.url}}/2020/07/10/what-are-confidence-intervals/">confidence intervals</a> for the estimate.
...
| ![Example Histogram]({{site.url}}/assets/2020/07/example_histogram.png) |
|:--:|
| *Example Histogram* |
