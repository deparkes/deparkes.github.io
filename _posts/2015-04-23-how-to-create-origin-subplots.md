...
| ![origin subplots - same axis]({{site.url}}/assets/2015/04/Graph1-1024x724.png) |
|:--:|
...
| ![origin subplots - extract to layers]({{site.url}}/assets/2015/04/extract_to_layers.png) |
|:--:|
...
| ![origin subplots - grid setup]({{site.url}}/assets/2015/04/GridSetup.png) |
|:--:|
...
| ![origin subplots - margins]({{site.url}}/assets/2015/04/Margins.png) |
|:--:|
| *origin subplots - margins* |

Click 'OK' to generate  your three subplots:

| ![origin subplots - generate subplots]({{site.url}}/assets/2015/04/subplot_output.png) |
|:--:|
...
| ![origin subplots - final graph]({{site.url}}/assets/2015/04/Graph2-1024x724.png) |
|:--:|
| *origin subplots - final graph* |

<h3><a href="{{site.url}}/2015/04/23/origin-linked-axis/">Find out how to make a linked axis in origin</a></h3>
