...
Monte Carlo simulation is related to the similar concept of <a href="{{site.url}}/2020/07/26/monte-carlo-integration/">Monte Carlo integration</a>.
...
| ![monte carlo simulation single run example]({{site.url}}/assets/2020/08/single_run.png) |
|:--:|
...
| ![monte carlo simulation second run]({{site.url}}/assets/2020/08/second_run.png) |
|:--:|
...
| ![monte carlo simulation - multiple time graphs]({{site.url}}/assets/2020/08/multi_time_simulation.png) |
|:--:|
...
| ![monte carlo simulation - mean queue size]({{site.url}}/assets/2020/08/mean_queue_size.png) |
|:--:|
...
| ![monte carlo simulation - max queue size]({{site.url}}/assets/2020/08/max_queue_size.png) |
|:--:|
...
| ![monte carlo simulation - max queue size with 10 desks]({{site.url}}/assets/2020/08/max_queue_size_10_desks.png) |
|:--:|
