...
| ![SQLite Import csv - SQLite Import csv - sqlitestudio]({{site.url}}/assets/2016/06/sqlitestudio.png) |
|:--:|
...
| ![SQLite Import csv - tools_import]({{site.url}}/assets/2016/06/tools_import.png) |
|:--:|
...
| ![SQLite Import csv - new_table]({{site.url}}/assets/2016/06/new_table.png) |
|:--:|
...
| ![SQLite Import csv - import_loading_screen]({{site.url}}/assets/2016/06/select_input_file.png) |
|:--:|
...
| ![SQLite Import csv - import_loading_screen]({{site.url}}/assets/2016/06/import_loading_screen.png) |
|:--:|
| *SQLite Import csv - import_loading_screen* |
...
| ![SQLite Import csv - data]({{site.url}}/assets/2016/06/data.png) |
|:--:|
