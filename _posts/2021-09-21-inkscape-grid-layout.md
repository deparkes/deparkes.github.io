...
| ![Scribus Guide Manager]({{site.url}}/assets/2021/09/GuideManager.png) |
|:--:|
...
| ![Scribus Grid Guides]({{site.url}}/assets/2021/09/GridGuides-1024x546.png) |
|:--:|
| *Scribus Grid Guides* |
...
| ![Scribus grid - single square]({{site.url}}/assets/2021/09/GridGuidesSquare-1024x546.png) |
|:--:|
| *Scribus grid - single square* |

Copy and paste that square to the other grid-squares on that row.

| ![Scribus grid row]({{site.url}}/assets/2021/09/GridGuidesSquareRow-1024x546.png) |
|:--:|
| *Scribus grid row* |

And then copy that row to the remaining columns.

| ![Scribus grid whole page]({{site.url}}/assets/2021/09/GridGuidesSquareWholePage-1024x546.png) |
|:--:|
...
| ![Inkscape grid loaded]({{site.url}}/assets/2021/09/GridExampleInkscape-1024x546.png) |
|:--:|
...
| ![Inkscape handle to cusp node]({{site.url}}/assets/2021/09/SnapToNodeCloseup.png) |
|:--:|
...
| ![Inkscape example layout with grid lines]({{site.url}}/assets/2021/09/SimpleGridUsageExample-1024x546.png) |
|:--:|
...
| ![Inkscape hide the grid layer]({{site.url}}/assets/2021/09/HideTheGridLayer-1024x546.png) |
|:--:|
