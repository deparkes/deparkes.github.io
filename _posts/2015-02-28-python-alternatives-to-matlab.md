...
<h2>3. Anaconda</h2>
<a href="{{site.url}}/assets/2014/06/anaconda_logo_web.png"><img class="wp-image-589 alignleft" src="{{site.url}}/assets/2015/02/anaconda_logo_web.png" alt="anaconda_logo_web" width="149" height="104"></a>Recommended by <a href="https://software-carpentry.org/">Software Carpentry</a>, <a href="https://store.continuum.io/cshop/anaconda/">Anaconda </a>has become my favourite scientific python environment.
In many ways Anaconda is similar to <a href="https://www.enthought.com/products/canopy/">Enthought Canopy</a>. It comes bundled with a range of scientific and numerical packages such as numpy and matplotlib, as well as having it's own <a href="https://conda.pydata.org/docs/">conda </a>package manager. The package manager makes it easy to install <a href="https://www.continuum.io/blog/conda">existing packages</a>, external packages as <a title="How to install whl files in Anaconda" href="{{site.url}}/2015/02/04/anaconda-whl-install/">whl files</a> or from <a href="https://binstar.org/">binstar.org</a>.
